...
Before you start the |cp|, make sure Hadoop is
...
Also, this quick start assumes that security is not configured for HDFS and Hive metastore,
...
.. note:: If you want to run the quick start with Hive integration, before starting the connector,
...
configuration options, see :ref:`hdfs-config-options`.
