...
1. Fork the connector repository into your GitHub account: https://github.com/confluentinc/kafka-connect-hdfs/fork
...
2. Clone your fork of the GitHub repository, replacing `<username>` with your GitHub username.
    ...
    ```bash
    git clone git@github.com:<username>/kafka-connect-hdfs.git
    ```

    Or https:

    ```bash
    git clone https://github.com/<username>/kafka-connect-hdfs.git
    ```

3. Add a remote to keep up with upstream changes.

    ```bash
    git remote add upstream https://github.com/confluentinc/kafka-connect-hdfs.git
    ```
...
8. Submit a pull-request
    ...
    ```bash
    https://github.com/<username>/kafka-connect-hdfs.git
    ```
